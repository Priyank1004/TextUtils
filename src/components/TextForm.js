    ...
    return (
        <>
            <div className="container">
                <h1>{props.heading}</h1>
                <div className="mb-3">
                    <textarea className="form-control" id="Mybox" rows="8" value={text} onChange={handleOnChange} placeholder='Enter The Text'></textarea>
                </div>
            ...
            <div className="conatiner my-3">
                ...
                <h2>Preview</h2>
                <p className='Text_proview_conatiner'>{text}</p>
            </div>
        </>
    )
}
